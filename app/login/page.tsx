    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200/70 mt-2">Russak Family Form Bot Dashboard</p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-transparent px-2 text-blue-200/40">or</span>
              </div>
            </div>
        ...
        <p className="text-center text-blue-200/30 text-xs mt-6">
          Only authorized Russak family members can access this dashboard.
        </p>
      </div>
    </div>
  );
